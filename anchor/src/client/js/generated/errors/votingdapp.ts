...
export const VOTINGDAPP_ERROR__VOTING_NOT_STARTED = 0x1770; // 6000
/** VotingEnded: Voting has ended */
export const VOTINGDAPP_ERROR__VOTING_ENDED = 0x1771; // 6001

export type VotingdappError =
  | typeof VOTINGDAPP_ERROR__VOTING_ENDED
  | typeof VOTINGDAPP_ERROR__VOTING_NOT_STARTED;

let votingdappErrorMessages: Record<VotingdappError, string> | undefined;
if (process.env.NODE_ENV !== 'production') {
  votingdappErrorMessages = {
    [VOTINGDAPP_ERROR__VOTING_ENDED]: `Voting has ended`,
    [VOTINGDAPP_ERROR__VOTING_NOT_STARTED]: `Voting has not started yet`,
  };
}
